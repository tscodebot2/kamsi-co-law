  ...
  const contactInfo = [
    {
      ...
      label: 'Address',
      value: '123 Legal Avenue, Central Business District, Abuja, Nigeria',
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Have a legal question or need assistance? Reach out to us today for a free,
            confidential consultation. Our team is ready to help.
          </p>
        </div>
            ...
            <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-lg p-8 border border-gray-100">
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gold-400 focus:border-transparent transition"
              ...
              <div className="mb-6">
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gold-400 focus:border-transparent transition resize-none"
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  type="submit"
                  className="btn-primary bg-gold-600 hover:bg-gold-700 text-white border-none"
                >
                  Send Message
                </button>
              </div>

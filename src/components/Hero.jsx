      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="text-center md:text-left">
            <div className="inline-block border-b-2 border-gold-400 pb-2 mb-6">
          ...
          <div className="hidden md:block relative">
            <div className="absolute inset-0 bg-gradient-to-br from-gold-400/20 to-primary-900/20 rounded-2xl transform rotate-3"></div>
            <div className="relative bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
              <div className="aspect-square rounded-lg bg-gradient-to-br from-primary-800 to-primary-900 flex items-center justify-center">
                <svg className="w-32 h-32 text-gold-400 opacity-50" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 2L2 7v10l10 5 10-5V7l12 4v4l-3 3V6l-2-2 3-3-3-3 3-3-2-2v16l-3-3-3 3-3-3 3-3V7l-2 4z"/>
                </svg>
              </div>
